                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control shadow-sm text-center text-dark bg-white font-weight-bold" id="exampleFormControlInput1" value="REGISTRATION FORM" readonly style="margin-top: -21.5px;">
                                                </div>

                                                <div class="form-group mt-5">
                                                    <input type="text" class="form-control" name="fname" placeholder="First name" pattern="^[A-Za-z]+$" value="" title="Enter your first name" required>
                                                </div>

                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="lname" placeholder="Last name" pattern="^[A-Za-z]+$" value="" title="Enter your last name" required>
                                                </div>

                                                <div class="form-group">
                                                    <input type="email" class="form-control" name="email" placeholder="name@example.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value="" title="Enter your email id" required>
                                                </div>

                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="location" placeholder="Location" pattern="^[A-Za-z]+$" value="" title="enter your address" required>
                                                </div>

                                                <div class="form-group">
                                                    <select name="academic" class="form-control" title="select your qualification" required>     
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="skill" placeholder="Programming skills known" pattern="^[A-Za-z]+$" value="" title="Enter your prgramming skills" required>
                                                </div> 

                                                <div class="form-group">
                                                    <select name="avail" class="form-control" title="select your qualification" required>
                                                ...
                                                <div class="custom-file mb-3 mb-5">
                                                    ...
                                                    <label class="custom-file-label"  for="validatedCustomFile">Upload CV/resume</label>
                                                    <input type="file" name="file" class="custom-file-input" required>
                                                </div>

                                                <button  name="submit" class="btn w-100 text-white font-weight-bolder" value="Submit" style="background-color: #00beb9; font-size: 18px; margin-bottom:-21.5px">Submit</button>
                                            </div>
                                            <div class="col-sm-2"></div>
                                        </div>
                                    </form>
