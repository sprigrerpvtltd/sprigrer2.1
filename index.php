				 ...
				 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
		            ...
		            <div class="row">
		                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex justify-content-center ">
		                        <ul>
		                            <li class="d-block d-inline" style="width: 14px; background:#213f66; height: 14px; border-radius: 100%; float: left;"></li>
			...
			<div class="row mt-5 pb-5 pt-5">
				<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6   mt-5" data-aos="slide-down" data-aos-duration="1000">
							<img src="images/about1.jpg" class="ml-5 shadow-md" style="border-radius: 25px;" width="75%" height="90%" alt="about">
						</div>
						...
						<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 mt-5 " data-aos="slide-up" data-aos-duration="1000">
							...
							<h4 class="text-left h4 mt-5 ml-5 mr-5">
							...
							<div id="btn1" class="rounded-pill mt-5 ml-5 mr-5" style="background: linear-gradient(to right, #213f66, #213f66);"><a href="about.php" class="text-white font-weight-bolder h3">Read More</a></div>
						</div>
		            ...
		            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
		                ...
		                <div class="row mt-5 ">
		                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mt-3 d-flex justify-content-center " data-aos="zoom-in" data-aos-duration="1000" >
		                        <div class="card text-center w-75 shadow-sm border border-dark" style=" border-radius:10px;">
									<div class="card-header border border-bottom-0 border-right-0 border-left-0 border-top-0" style="background: linear-gradient(to right, #213f66, #213f66);border-top-left-radius:10px; border-top-right-radius:10px;">
                                        <img src="./images/application.png" class="img-fluid mt-3 mb-3" style="width:160px; height:187.5px;">
                                    </div>
		                            <div class="card-body " style="">
		                                <p class=" font-weight-bold" style="font-size: 20px;">MOBILE APPLICATION</p>
		                            </div>
		                        </div>
		                    </div>
		                    ...
		                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mt-3 d-flex justify-content-center" data-aos="zoom-in" data-aos-duration="1000">
                                <div class="card  text-center w-75 shadow-sm border border-dark" style=" border-radius:10px;">
									<div class="card-header border border-bottom-0 border-right-0 border-left-0 border-top-0" style="background: linear-gradient(to right, #213f66, #213f66);border-top-left-radius:10px; border-top-right-radius:10px;">
                                        <img src="./images/Layer 32.png" class="img-fluid mt-3 mb-3" style="width:170px; height:187.5px;">
                                    </div>
		                            <div class="card-body">
		                                <p class=" font-weight-bold " style="font-size: 20px;">GAME DEVELOPMENT</p>
		                            </div>
		                        </div>
		                    </div>
		                    ...
		                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mt-3 d-flex justify-content-center " data-aos="zoom-in" data-aos-duration="1000">
                                <div class="card text-center w-75 shadow-sm border border-dark" style=" border-radius:10px;">
                                    ...
                                    <div class="card-header border border-bottom-0 border-right-0 border-left-0 border-top-0" style="background: linear-gradient(to right, #213f66, #213f66);border-top-left-radius:10px; border-top-right-radius:10px;">
                                        <img src="./images/iot.png" class="img-fluid mt-3 mb-3" style="width:190px; height:187.5px;">
                                    </div>
		                            <div class="card-body">
		                                <p class=" font-weight-bold  " style="font-size: 20px;">IOT</p>
		                            </div>
		                        </div>
		                    </div>                         
		                </div>
		                ...
		                <div class="row mt-5">
		                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 d-flex justify-content-center">
		                        <div id="btn2" class="rounded-pill" style="background: linear-gradient(to right, #213f66, #213f66);"><a href="services.php" class="text-white font-weight-bolder h3">ALL SERVICES</a></div>
		                    </div>
		                </div>
		            </div>
